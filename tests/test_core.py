...
from btc_stack_builder.core.models import (
    ...
    Portfolio, SubPortfolio, SubPortfolioType, PortfolioAllocation,
    Strategy, StrategyType, StrategyStatus, StrategyConfig,
...
class TestConstants:
    ...
    def test_margin_thresholds(self):
        ...
        assert MARGIN_RATIO_WARNING_THRESHOLD > MARGIN_RATIO_CRITICAL_THRESHOLD, \
    ...
    def test_option_delta_target_range(self):
        ...
        assert Decimal("0") < OPTION_DELTA_TARGET < Decimal("1"), \
    ...
    def test_global_stop_loss_threshold(self):
        ...
        assert GLOBAL_STOP_LOSS_THRESHOLD < Decimal("0"), \
...
class TestUtils:
    ...
    def test_calculate_annualized_basis(self):
        ...
        assert abs(calculated_basis - expected_basis) < Decimal("0.001"), \
    ...
    def test_calculate_funding_rate(self):
        ...
        assert abs(calculated_rate - expected_rate) < Decimal("0.001"), \
    ...
    def test_calculate_margin_ratio(self):
        ...
        assert calculated_ratio == expected_ratio, \
    ...
    def test_calculate_position_pnl(self):
        ...
        assert result["absolute_pnl"] == Decimal("5000"), \
            f"Expected 5000, got {result['absolute_pnl']}"
        assert result["percentage_pnl"] == Decimal("0.1"), \
    ...
    def test_satoshi_to_btc_conversion(self):
        ...
        assert satoshi_to_btc(satoshis) == expected_btc, \
    ...
    def test_btc_to_satoshi_conversion(self):
        ...
        assert btc_to_satoshi(btc) == expected_satoshis, \
    ...
    def test_datetime_to_timestamp(self):
        ...
        dt = datetime(2022, 5, 31, 12, 0, 0, tzinfo=timezone.utc)
    ...
    def test_format_btc_amount(self):
        ...
        assert formatted == "1.23456789 BTC", \
            f"Expected '1.23456789 BTC', got '{formatted}'"
        ...
        assert formatted == "1.2346", \
            f"Expected '1.2346', got '{formatted}'"
