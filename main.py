...
from btc_stack_builder.config import config, Environment
from btc_stack_builder.core.logger import logger, setup_logger
from btc_stack_builder.core.models import (
    Exchange, ExchangeCredentials, Strategy, StrategyType, StrategyStatus,
    Portfolio, SubPortfolio, SubPortfolioType, PortfolioAllocation
)
from btc_stack_builder.db.session import init_db, get_engine, get_session_factory
...
from btc_stack_builder.monitoring.metrics import setup_metrics, register_metrics
...
async def main_async(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        logger.info(f"BTC Stack-Builder Bot v{__version__} started in {config.environment.value} mode")
